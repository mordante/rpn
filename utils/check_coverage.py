...
not_covered = {
    path
    + "/src/modules/calculator/controller.cpp": {
        "lines": 14,
        "branches": 11,
        "regions": 6,
    },
    path
    + "/src/modules/calculator/math/arithmetic.cpp": {
        "lines": 6,
        "branches": 2,
        "regions": 0,
    },
    ...
    path
    + "/src/modules/lib/dictionary.cpp": {
        "lines": 13,
        "branches": 0,
        "regions": 1,
    },
    path
    + "/src/modules/lib/binary_find.cpp": {
        "lines": 0,
        "branches": 0,
        "regions": 1,
    },
    path
    + "/src/modules/parser/detail/base.cpp": {
        "lines": 2,
        "branches": 3,
        "regions": 2,
    },
    ...
    path
    + "/src/modules/parser/detail/floating_point.cpp": {
        "lines": 4,
        "branches": 3,
        "regions": 2,
    },
    path
    + "/src/modules/parser/detail/signed.cpp": {
        "lines": 7,
        "branches": 5,
        "regions": 4,
    },
    path
    + "/src/modules/parser/detail/string.cpp": {
        "lines": 1,
        "branches": 1,
        "regions": 1,
    },
    path
    + "/src/modules/parser/detail/unsigned.cpp": {
        "lines": 8,
        "branches": 7,
        "regions": 4,
    },
    path
    + "/src/modules/parser/token.cpp": {
        "lines": 1,
        "branches": 0,
        "regions": 1,
    },
...
for file in coverage["data"][0]["files"]:
    ...
    lines = (
        file["summary"]["lines"]["count"] - file["summary"]["lines"]["covered"]
    )
    ...
    if expected == None:
        ...
        or branches != expected["branches"]
        or regions != expected["regions"]
    ):
        kind = "Explicit"
    ...
    if kind != None:
        ...
        print(
            "{}\n\t{}\n\tlines = {}\n\tbranches = {}\n\tregions = {}".format(
                filename, kind, lines, branches, regions
            )
        )
